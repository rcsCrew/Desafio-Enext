...
@Component({
  selector: 'app-potion-product',
  standalone: false,
  
  templateUrl: './potion-product.component.html',
  styleUrl: './potion-product.component.scss'
})
export class PotionProductComponent {
    potions = [
      {
        potions: {
          "1": {
    ...
    getPotionsArray() {
      return Object.values(this.potions[0].potions);
    }selectedPotion: any = null;

    openLightbox(potion: any) {
